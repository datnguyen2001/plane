    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            <div class="bg-white p-4">
                <form action="{{url("admin/news/update",$new->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row mt-3">
                        ...
                        <div class="col-8">
                            <div class="form-control position-relative div-parent" style="padding-top: 50%">
                                <div class="position-absolute w-100 h-100 div-file" style="top: 0; left: 0;z-index: 10">
                                    ...
                                    <img src="{{asset($new->src)}}" class="w-100 h-100" style="object-fit: cover">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-3">
                        ...
                        <textarea name="describe" id="describe" required rows="4"
                                  class="form-control">{{$new->describe}}</textarea>
                        </div>
                    </div>
                    <div class="card mt-3">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-8">
                            <div class="form-check form-switch">
                                <input class="form-check-input" name="display" @if($new->display == 1) checked @endif type="checkbox"
