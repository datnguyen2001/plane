    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            <div class="bg-white p-4">
                <form action="{{url("admin/image-about/update",$banner->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row mt-3">
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-8">
                            ...
                            <a href="{{route('admin.image-about.index')}}" class="btn btn-danger">Hủy</a>
                        </div>
