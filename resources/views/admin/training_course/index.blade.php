                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a class="btn btn-success"
                                   href="{{route('admin.training-course.create')}}">Thêm mới tin tức</a>
                            </div>
                            <table class="table">
